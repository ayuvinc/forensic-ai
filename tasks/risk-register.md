...
| R-009 | OPEN | PROCESS | No live smoke test run — 57 modules structural only, never tested with real API keys | High | Blocked on R-002; schedule smoke test when API key available in this environment |
